...
export default class OpenAPIValidateCommand extends BaseCommand {
    id = 'openapi validate';
    static summary = 'Validate your OpenAPI/Swagger definition.';
    static description = 'Perform a local validation of your API definition (no ReadMe account required!), which can be useful when constructing or editing your API definition.';
