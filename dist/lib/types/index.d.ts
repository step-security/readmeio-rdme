...
type apiUploadSingleResponseSchema = (typeof readmeAPIv2Oas)['paths']['/branches/{branch}/apis/{filename}']['get']['responses']['200']['content']['application/json']['schema'];
type stagedApiUploadResponseSchema = (typeof readmeAPIv2Oas)['paths']['/branches/{branch}/apis']['post']['responses']['202']['content']['application/json']['schema'];
type apiDefinitionsSchema = (typeof readmeAPIv2Oas)['paths']['/branches/{branch}/apis']['get']['responses']['200']['content']['application/json']['schema'];
/** Page schemas */
export type PageRoute = APIv2PageUploadCommands['route'];
type PageRequestSchemaRaw<T extends PageRoute> = T extends 'custom_pages' | 'guides' | 'reference' ? (typeof readmeAPIv2Oas)['paths'][`/branches/{branch}/${T}/{slug}`]['patch']['requestBody']['content']['application/json']['schema'] : T extends 'changelogs' ? (typeof readmeAPIv2Oas)['paths']['/changelogs/{identifier}']['patch']['requestBody']['content']['application/json']['schema'] : never;
type PageResponseSchemaRaw<T extends PageRoute> = T extends 'custom_pages' | 'guides' | 'reference' ? (typeof readmeAPIv2Oas)['paths'][`/branches/{branch}/${T}/{slug}`]['patch']['responses']['200']['content']['application/json']['schema'] : T extends 'changelogs' ? (typeof readmeAPIv2Oas)['paths']['/changelogs/{identifier}']['patch']['responses']['200']['content']['application/json']['schema'] : never;
/**
 ...
 */
export type APIUploadSingleResponseRepresentation = FromSchema<apiUploadSingleResponseSchema, {
    keepDefaultedPropertiesOptional: true;
}>;
/**
 ...
 */
export type StagedAPIUploadResponseRepresentation = FromSchema<stagedApiUploadResponseSchema, {
    keepDefaultedPropertiesOptional: true;
}>;
 ...
 */
export type PageRequestSchema<T extends PageRoute> = FromSchema<PageRequestSchemaRaw<T>, {
    keepDefaultedPropertiesOptional: true;
}>;
/**
 * Derived from our API documentation, this is the schema for the page objects
 ...
 */
export type PageResponseSchema<T extends PageRoute> = FromSchema<PageResponseSchemaRaw<T>, {
    keepDefaultedPropertiesOptional: true;
}>;
/**
 ...
 * as we receive it from the ReadMe API.
 */
export type APIDefinitionsRepresentation = FromSchema<apiDefinitionsSchema, {
    keepDefaultedPropertiesOptional: true;
}>;
export {};
