    ...
    paths: {
        ...
        '/branches/{branch}/custom_pages': {
            post: {
                ...
                tags: ['Custom Pages'],
                description: 'Create a custom page in your ReadMe project.\n\n>📘\n> This route is only available to projects that are using [ReadMe Refactored](https://docs.readme.com/main/docs/welcome-to-readme-refactored).',
                requestBody: {
                    content: {
                        'application/json': {
                            schema: {
            ...
            get: {
                ...
                tags: ['Custom Pages'],
                description: 'Get all custom pages from your ReadMe project.\n\n>📘\n> This route is only available to projects that are using [ReadMe Refactored](https://docs.readme.com/main/docs/welcome-to-readme-refactored).',
                parameters: [
                    {
                        schema: {
                            type: 'string',
        ...
        '/branches/{branch}/custom_pages/{slug}': {
            ...
            delete: {
                ...
                tags: ['Custom Pages'],
                description: 'Delete a custom page from your ReadMe project.\n\n>📘\n> This route is only available to projects that are using [ReadMe Refactored](https://docs.readme.com/main/docs/welcome-to-readme-refactored).',
                parameters: [
                    {
                        schema: {
                            type: 'string',
            ...
            patch: {
                ...
                tags: ['Custom Pages'],
                description: 'Update an existing custom page in your ReadMe project.\n\n>📘\n> This route is only available to projects that are using [ReadMe Refactored](https://docs.readme.com/main/docs/welcome-to-readme-refactored).',
                requestBody: {
                    content: {
                        'application/json': {
                            schema: {
        ...
        '/branches/{branch}/guides': {
            post: {
                ...
                tags: ['Guides'],
                description: 'Create a page in the Guides section of your ReadMe project.\n\n>📘\n> This route is only available to projects that are using [ReadMe Refactored](https://docs.readme.com/main/docs/welcome-to-readme-refactored).',
                requestBody: {
                    content: {
                        'application/json': {
                            schema: {
        ...
        '/branches/{branch}/guides/{slug}': {
            get: {
                ...
                tags: ['Guides'],
                description: 'Get a page from the Guides section of your ReadMe project.\n\n>📘\n> This route is only available to projects that are using [ReadMe Refactored](https://docs.readme.com/main/docs/welcome-to-readme-refactored).',
                parameters: [
                    {
                        schema: {
                            type: 'string',
            ...
            delete: {
                ...
                tags: ['Guides'],
                description: 'Delete a page from the Guides section of your ReadMe project.\n\n>📘\n> This route is only available to projects that are using [ReadMe Refactored](https://docs.readme.com/main/docs/welcome-to-readme-refactored).',
                parameters: [
                    {
                        schema: {
                            type: 'string',
        ...
        '/branches/{branch}/reference': {
            post: {
                ...
                tags: ['API Reference'],
                description: 'Create a page in the API Reference section of your ReadMe project.\n\n>📘\n> This route is only available to projects that are using [ReadMe Refactored](https://docs.readme.com/main/docs/welcome-to-readme-refactored).',
                requestBody: {
                    content: {
                        'application/json': {
                            schema: {
        ...
        '/branches/{branch}/reference/{slug}': {
            ...
            patch: {
                ...
                tags: ['API Reference'],
                description: 'Updates an existing page in the API Reference section of your ReadMe project.\n\n>📘\n> This route is only available to projects that are using [ReadMe Refactored](https://docs.readme.com/main/docs/welcome-to-readme-refactored).',
                requestBody: {
                    content: {
                        'application/json': {
                            schema: {
                                ...
                                properties: {
                                    ...
                                    api: {
                                        ...
                                        additionalProperties: false,
                                        description: 'Information about the API that this reference page is attached to. If you wish to detach this page from an API definition, making it a stand page, set `api.uri` to `null`.',
                                    },
                                    position: { type: 'number' },
                                },
                                additionalProperties: false,
        ...
        '/branches/{branch}/recipes': {
            get: {
                ...
                tags: ['Recipes'],
                description: 'Get all recipes from your ReadMe project.\n\n>📘\n> This route is only available to projects that are using [ReadMe Refactored](https://docs.readme.com/main/docs/welcome-to-readme-refactored).',
                parameters: [
                    {
                        schema: {
                            type: 'string',
            ...
            post: {
                ...
                tags: ['Recipes'],
                description: 'Create a new recipe in your ReadMe project.\n\n>📘\n> This route is only available to projects that are using [ReadMe Refactored](https://docs.readme.com/main/docs/welcome-to-readme-refactored).',
                requestBody: {
                    content: {
                        'application/json': {
                            schema: {
        ...
        '/branches/{branch}/recipes/{slug}': {
            ...
            delete: {
                ...
                tags: ['Recipes'],
                description: 'Delete a recipe from your ReadMe project.\n\n>📘\n> This route is only available to projects that are using [ReadMe Refactored](https://docs.readme.com/main/docs/welcome-to-readme-refactored).',
                parameters: [
                    {
                        schema: {
                            type: 'string',
            ...
            patch: {
                ...
                tags: ['Recipes'],
                description: 'Update an existing recipe in your ReadMe project.\n\n>📘\n> This route is only available to projects that are using [ReadMe Refactored](https://docs.readme.com/main/docs/welcome-to-readme-refactored).',
                requestBody: {
                    content: {
                        'application/json': {
                            schema: {
        ...
        '/branches': {
            get: {
                ...
                tags: ['Branches'],
                description: 'Get a collection of branches in your ReadMe project.\n\n>📘\n> This route is only available to projects that are using [ReadMe Refactored](https://docs.readme.com/main/docs/welcome-to-readme-refactored).',
                parameters: [
                    {
                        schema: { type: 'number', minimum: 1, default: 1 },
                        in: 'query',
        ...
        '/branches/{branch}': {
            get: {
                ...
                tags: ['Branches'],
                description: 'Get a branch of your ReadMe project.\n\n>📘\n> This route is only available to projects that are using [ReadMe Refactored](https://docs.readme.com/main/docs/welcome-to-readme-refactored).',
                parameters: [
                    {
                        schema: {
                            type: 'string',
            ...
            patch: {
                ...
                tags: ['Branches'],
                description: 'Update an existing branch in your ReadMe project.\n\n>📘\n> This route is only available to projects that are using [ReadMe Refactored](https://docs.readme.com/main/docs/welcome-to-readme-refactored).',
                requestBody: {
                    content: {
                        'application/json': {
                            schema: {
                                ...
                                description: 'Dependent upon the type of resource you are updating this is the representation for a branch or version.',
                            },
                        },
                    },
                    description: 'Dependent upon the type of resource you are updating this is the representation for a branch or version.',
            ...
            delete: {
                ...
                tags: ['Branches'],
                description: 'Delete a branch from your ReadMe project.\n\n>📘\n> This route is only available to projects that are using [ReadMe Refactored](https://docs.readme.com/main/docs/welcome-to-readme-refactored).',
                parameters: [
                    {
                        schema: {
                            type: 'string',
