...
export const branchFlag = (additionalDescription = []) => ({
    branch: Flags.string({
        aliases: ['version'],
        default: 'stable',
...
export const keyFlag = Flags.string({
    ...
    required: true,
    description: 'An API key for your ReadMe project. Note that API authentication is required despite being omitted from the example usage. See our docs for more information: https://github.com/step-security/rdme/tree/v10#authentication',
});
/**
...
export const specArg = Args.string({
    description: 'A path to your API definition — either a local file path or a URL. If your working directory and all subdirectories contain a single OpenAPI file, you can omit the path.',
});
