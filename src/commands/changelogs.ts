...
export default class ChangelogsCommand extends BaseCommand<typeof ChangelogsCommand> {
  ...
  static deprecationOptions = {
    message: `\`rdme ${this.id}\` is deprecated in favor of \`rdme changelog upload\`. For more information, please visit our migration guide: https://github.com/step-security/readmeio-rdme/blob/v10/documentation/migration-guide.md`,
  };
