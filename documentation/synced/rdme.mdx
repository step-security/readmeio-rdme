...
<p align="center">
  ...
  <a href="https://github.com/step-security/rdme">
    <img
      src="https://img.shields.io/github/actions/workflow/status/step-security/rdme/ci.yml?branch=main&style=for-the-badge"
      alt="Build status"
    />
  </a>
</p>
...
<p align="center">
  <a href="https://readme.com">
    <img src="https://raw.githubusercontent.com/step-security/.github/main/oss-badge.svg" />
  </a>
</p>
...
- Syncing [OpenAPI/Swagger](https://docs.readme.com/main/docs/openapi) definitions (with support for bundling external references) 📦
- Pre-upload validation (including OpenAPI 3.1) ✅
- Syncing directories of Markdown files 📖

## General Setup and Usage

To see detailed CLI setup instructions and all available commands, check out [the `rdme` GitHub repository](https://github.com/step-security/rdme#readme).
...
>
> For more information, check out our [migration guide](https://github.com/step-security/rdme/blob/v10/documentation/migration-guide.md)
...
| Attribute      | Required for `changelog upload`? | Required for `custompages upload`? | Required for `docs upload`? | Required for `reference upload`? |
| :------------- | :------------------------------- | :--------------------------------- | :-------------------------- | :------------------------------- |
...
> 📘
>
> Note that the above attributes are only required for the initial page creation and are not required for any subsequent updates. Any Markdown/HTML files that lack YAML frontmatter attributes will be skipped.

To determine what your `category.uri` value should be, you can use [the `Get all categories` endpoint](https://docs.readme.com/reference/getcategories-1) and grab the `uri` value from one of the category objects. With `rdme`, you can do either of the following formats to denote the category URI:

- The full URI, exactly as denoted in the [the `Get all categories` endpoint](https://docs.readme.com/reference/getcategories-1) response:
...
- The category title (i.e., the very last part of the URI)
...
`rdme` is directory-agnostic by design, meaning that you can organize your local directory of Markdown files however you'd like and it will not impact how ReadMe displays them in the sidebar. This also means that any page hierarchy attributes must be specified in the frontmatter of each Markdown file.
...
- uses: step-security/rdme@RDME_VERSION
  with:
...
>
> - [The Markdown source file for the page you're reading](https://github.com/step-security/rdme/blob/main/documentation/synced/rdme.md)
> - [The GitHub Actions workflow file that syncs the Markdown to docs.readme.com](https://github.com/step-security/rdme/blob/main/.github/workflows/docs.yml)
> - And finally... [the workflow run results](https://github.com/step-security/rdme/actions/workflows/docs.yml)
...
- [Syncing an OpenAPI definition](https://docs.readme.com/main/docs/github-actions-openapi-example)
- [Syncing a directory of Markdown files](https://docs.readme.com/main/docs/github-actions-docs-example)
...
If you notice any issues with any of these examples, please open up an issue on [the `rdme` repository on GitHub](https://github.com/step-security/rdme).
