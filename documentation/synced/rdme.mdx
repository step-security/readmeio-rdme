...
<p align="center">
  ...
  <a href="https://github.com/step-security/readmeio-rdme">
    <img
      src="https://img.shields.io/github/actions/workflow/status/step-security/readmeio-rdme/ci.yml?branch=main&style=for-the-badge"
      alt="Build status"
    />
  </a>
</p>
...
- uses: step-security/readmeio-rdme@RDME_VERSION
  with:
...
>
> - [The Markdown source file for the page you're reading](https://github.com/step-security/readmeio-rdme/blob/main/documentation/synced/rdme.md)
> - [The GitHub Actions workflow file that syncs the Markdown to docs.readme.com](https://github.com/step-security/readmeio-rdme/blob/main/.github/workflows/docs.yml)
> - And finally... [the workflow run results](https://github.com/step-security/readmeio-rdme/actions/workflows/docs.yml)
...
If you notice any issues with any of these examples, please open up an issue on [the `rdme` repository on GitHub](https://github.com/step-security/readmeio-rdme).
